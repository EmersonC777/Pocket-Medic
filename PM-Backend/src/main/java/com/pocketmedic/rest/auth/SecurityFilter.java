...
public class SecurityFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        if (authHeader == null || authHeader.isEmpty() || authHeader.split(" ").length != 2) {
            Authorizer authorizer = new Authorizer(new Roles(),
                    "",
            ...
            if (new DateTime(claimSet.getExpirationTime()).isBefore(DateTime.now())) {
                ...
                Usuarios user = usuariosFacade.find(Integer.parseInt(claimSet.getSubject()));
    ...
    public static class Authorizer implements SecurityContext{
        ...
        public Authorizer(Roles rol, String username, boolean isSecure) {
            this.roles = rol;
        ...
        return roles.getIdRol().equals(Integer.parseInt(role));
        }
